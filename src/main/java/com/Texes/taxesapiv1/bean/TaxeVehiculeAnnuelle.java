 ...
 */
@Entity
public class TaxeVehiculeAnnuelle implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TaxeVehiculeAnnuelle)) {
            return false;
        }
        TaxeVehiculeAnnuelle other = (TaxeVehiculeAnnuelle) object;
    ...
    public String toString() {
        return "com.Texes.taxesapiv1.bean.TauxVehiculeAnneulle[ id=" + id + " ]";
    }
